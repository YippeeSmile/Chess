...
function chessBoard() {
    let chessTable = document.getElementById('TableChess');
    for (let i = 0; i < 10; i++) {
    ...
    document.body.appendChild(chessTable); //вывод таблицы в body
    console.log(chessTable); // вывод таблицы в консоль
}
...
chessBoard(); // вызов функции, которая создает таблицу
*/
